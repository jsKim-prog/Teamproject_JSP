...
public class MemberDTO {
	...
	// 필드 --DB와 공유되는 필드
	   ...
	   private String mail;
	   private int author; //0-guest, 1-user, 2-manager, 3-admin
	...
	public String toString() {
		return "MemberDTO [mno=" + mno + ", id=" + id + ", pw=" + pw + ", name=" + name + ", nickName=" + nickName
				+ ", birth=" + birth + ", sex=" + sex + ", pNo=" + pNo + ", mail=" + mail + ", author=" + author
				+ ", usability=" + usability + ", loginStatus=" + loginStatus + "]";
	}
